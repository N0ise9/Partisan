...
`h-istasi boot | authority build 2026-07-06-runtime-proof-r10-direct-faction`
and the client log must contain
`build=2026-07-06-menu-input-r10-direct-faction` on the local command-menu ready
