...
`logs_2026-07-13_18-21-56` records one passing testcase and `AllExact=1`, covering
...
environment also records a recoverable stock VM exception and stock filter-
constructor errors before the HST testcase succeeds, so it is not exception-
free.

This is not full runtime certification. Full Campaign Debug Phase 17 and
packaged, dedicated-server, serialization/restart, network/JIP/reconnect, and
...
| Certification | Schema 70/settings 24 is sealed at implementation `2f71236bfc02329a3c8000b104f1b7b1043dc99c`, stamp `ef95555`, and label `schema70-settings24-exact-enemy-garrison-rebuild-engine-proof`. Foundation passes at 790 references. Stamped Workbench compile/create log `logs_2026-07-13_18-21-32` passes at CRC `8ed66143`; focused autotest log `logs_2026-07-13_18-21-56` records one passing testcase and `AllExact=1`, but its stock environment is not exception-free. Schema 69 remains a historical sealed checkpoint. | Execute Full Campaign Debug Phase 17, then package-prove serialization/restart, physical/virtual combat, canonical ownership and exact settlement, profile migration, markers, rendered UI, performance, dedicated/live server, multiplayer/networking, reconnect, JIP, and soak behavior. |
