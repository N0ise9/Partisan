...
- Phase 14-24 smoke steps remain partly legacy string classifications outside the newly typed Phase 14 arsenal, Phase 15 garage/source-vehicle, Phase 16 garrison/training, Phase 17 capture/counterattack state, Phase 18/19 enemy/support, Phase 20/21 civilian/undercover, Phase 22 HQ/Defend Petros, and Phase 24 pacing/end probes. Counterattack physical advance, Defend Petros attacker movement/waves, and UI/markers still need stronger typed assertions. Phase 16 proves abstract garrison/training state only; it does not physicalize recruited units. Phase 17 proves counterattack order state only; it does not sample attacker movement. Phase 22 proves HQ/order/mission/task/marker/recovery state only; it does not sample attacker movement. Phase 24 does not yet prove long-window escalation pressure or post-end service inactivity.
