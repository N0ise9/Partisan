...
1. Repack and rerun the dedicated server proof on the r117 marker/group/civilian
   cleanup build, then compare icon deconflicts, Western Heights removal,
   ...
   civilian CIV faction classification, command menu row clarity, radio support
   drift, and security-pressure drift against playtest notes.
