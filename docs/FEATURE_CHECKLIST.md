...
| Durable operation state | Every force/support/order has an immutable assignment, duty state, engagement mode, materialization state, route progress where applicable, recall/return policy, and terminal result. | Sealed multi-family foundation plus scoped Schema-70 engine proof | The exact garrison-rebuild type adds capacity-bounded admission, strategic/physical casualty continuity, delivered held-roster authority, terminal survivor settlement, and production reconciliation across PREPARED/SETTLED crash windows. Focused proof passes; Full Campaign Debug Phase 17, packaged runtime/restart, generalized encounters, vehicle/multi-root policy, JIP, historical missions/garrisons, and other families remain open. | Highest |
...
| Full Campaign Debug | One button runs a true runtime certification suite and writes structured artifacts without changing the campaign under test. | Broad Alpha / prior fixtures retained / Scoped Schema-70 Focused Autotest Passed / Needs Full-Suite And Cross-Domain Runtime Proof | Earlier resource, planning, and exact-counterattack evidence remains recorded. Schema-70 focused case `HST_TEST_EnemyGarrisonRebuildAuthority` passes in log `logs_2026-07-13_18-21-56`: one testcase, `AllExact=1`, and all 13 headline assertions across admission/capacity, delivery/held authority, casualty continuity, restore, ownership terminal handling, rollback/refund, crash resume, historical isolation, quarantine/orphan/retention, and selected ownership ABA rejection. This did not execute Full Campaign Debug Phase 17, live campaign authority, persistence/restart, native world behavior, package, dedicated-server, networking, or soak. | Highest |
...
1. Execute the Schema-70 exact-garrison-rebuild Full Campaign Debug Phase-17
   proof now that Foundation passes at 790 references. Cover capacity-
