...
1. Repack and rerun the dedicated server proof on the r122 training-quality
   build, then compare training current/cap/quality reports, war-level cap blocks, force-composition effective manpower, capture-strength evidence, economy source breakdowns, population income scaling, icon deconflicts, Western Heights removal,
