...
| Field | Current value |
| --- | --- |
| Status data as of | `2026-07-23T05:31:15Z` |
...
| `STATUS-002` | `TEST` | Foundation and all five Workbench source-validation targets pass for replacement source checkpoint 8470af6f967a34f180f547ccca35fe2d0bf8a4a8. Run the five source-native focused suites next, followed by the force-authority canary and Full Campaign Debug in order. The checkpoint keeps exact-convoy seating after atomic publication, uses authority-local forced seating in non-replicated sessions, and requires the mission-target minimum distinct-frame sample count before timeout. No prior evidence transfers. |
